...
class NYT_Config:
    def __init__(self, conf):
        ...
        self.train_dir='pkl/models_nyt_'+self.model_name+ablation
        self.log_file = 'log/log_nyt_%s.txt' %self.model_name+ablation
        self.result_file = 'result/result_nyt_%s.txt' %self.model_name+ablation
...
class WebNLG_Config:
    def __init__(self, conf):
        ...
        # self.lambda_value=5.0
        self.lambda_value=0.8
        # self.train_dir='pkl/models_webnlg_'+self.model_name
        # self.train_dir='pkl/models_webnlg_multi_head'
        # self.log_file = 'log/log_webnlg_%s.txt' %self.model_name
        # self.result_file = 'result/result_webnlg_%s.txt' %self.model_name

        # ablation='_no_cnn_3'
        # ablation='_big300_2'
        # ablation='_no_concat'
        # ablation='lambda_'+str(self.lambda_value)
        # ablation="_duli_match"
        ablation="_duli_cnn"
        ...
        # self.train_dir='pkl/models_webnlg_'+self.model_name+'lambda1'
        # self.log_file = 'log/log_webnlg_%s.txt' %self.model_name+'lambda1'
        # self.result_file = 'result/result_webnlg_%s.txt' %self.model_name+'lambda1'
        # self.lambda_value=5.0
        # self.train_dir='pkl/models_webnlg_'+self.model_name+'lambda5'
        # self.log_file = 'log/log_webnlg_%s.txt' %self.model_name+'lambda5'
        # self.result_file = 'result/result_webnlg_%s.txt' %self.model_name+'lambda5'
        # self.lambda_value=3.0
        # self.train_dir='pkl/models_webnlg_'+self.model_name+'lambda3_1'
        # self.log_file = 'log/log_webnlg_%s.txt' %self.model_name+'lambda3_1'
        # self.result_file = 'result/result_webnlg_%s.txt' %self.model_name+'lambda3_1'
        print(self.result_file)
